...
export const RegisterSchema = z.object({
  ...
  role: z.enum(['Admin', 'Manager', 'Accountant', 'Driver', 'Sales', 'Director']).default('Driver'),
});

export const RegistrationRequestSchema = z.object({
  name: z.string().min(1),
  email: z.string().email(),
  role: z.enum(['Driver', 'Accountant', 'Manager', 'Sales', 'Director']).default('Driver'),
});
...
export const UserSchema = z.object({
  ...
  email: z.string().email(),
  password: z.string().min(8),
  role: z.enum(['Admin', 'Manager', 'Accountant', 'Driver', 'Sales', 'Director']),
...
export const UserUpdateSchema = z.object({
  ...
  role: z.enum(['Admin', 'Manager', 'Accountant', 'Driver', 'Sales', 'Director']).optional(),
