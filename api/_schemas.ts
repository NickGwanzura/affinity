...
export const RegisterSchema = z.object({
  ...
  role: z.enum(['Admin', 'Manager', 'Accountant', 'Driver', 'Sales', 'Director', 'Car Hire', 'CEO']).default('Driver'),
});

export const RegistrationRequestSchema = z.object({
  name: z.string().min(1),
  email: z.string().email(),
  role: z.enum(['Driver', 'Accountant', 'Manager', 'Sales', 'Director', 'Car Hire', 'CEO']).default('Driver'),
});
...
export const UserUpdateSchema = z.object({
  ...
  role: z.enum(['Admin', 'Manager', 'Accountant', 'Driver', 'Sales', 'Director', 'Car Hire', 'CEO']).optional(),
