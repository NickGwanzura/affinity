...
const { default: exchangeRatesHandler }      = await import('./api/exchange-rates.js');
const { default: expensesHandler }           = await import('./api/expenses.js');
const { default: freezitHandler }            = await import('./api/freezit.js');
const { default: fundDisbursementsHandler }  = await import('./api/fund-disbursements.js');
const { default: goodsPickupHandler }        = await import('./api/goods-pickup.js');
...
const { default: publicGoodsPickupHandler }  = await import('./api/public-goods-pickup.js');
...
app.all('/api/exchange-rates', mount(exchangeRatesHandler));
...
app.all('/api/goods-pickup', mount(goodsPickupHandler));
...
app.all('/api/public-goods-pickup', mount(publicGoodsPickupHandler));
