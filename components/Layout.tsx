  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-white border-b border-zinc-200 sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold tracking-[0.2em] text-blue-600 uppercase">Logistics</p>
              </div>
            </div>
               ...
               <div className="hidden sm:flex items-center gap-3 px-3 py-2 bg-zinc-50 rounded-xl border border-zinc-100">
                  <div className="flex items-center gap-2">
                    <div className="w-8 h-8 rounded-full border-2 border-white shadow-sm overflow-hidden">
                      <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${user.name}`} className="w-full h-full" alt={`${user.name} profile photo`} />
                    </div>
                    <div>
        ...
        {mobileMenuOpen && (
          <div id="mobile-nav" className="lg:hidden border-t border-zinc-200 bg-white">
      ...
      <main id="main-content" className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6 pb-24 lg:pb-10">
        {children}
      </main>
      ...
      <footer className="bg-zinc-50 border-t border-zinc-200 py-10 mt-20">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2 opacity-60">
             <div className="w-6 h-6 bg-zinc-900 rounded flex items-center justify-center text-white text-xs font-black">A</div>
