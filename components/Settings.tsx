  ...
  useEffect(() => {
    const load = async () => {
      ...
      const [c, i, r, logs] = await Promise.all([
        ...
        dataService.getAuditLogs(150).catch((e: unknown) => {
          console.error('[Settings] getAuditLogs:', e);
          return [] as AuditLog[];
        }),
      ]);
        ...
        >
          <button
            ...
            className={`px-6 py-4 text-sm font-semibold transition-all border-b-2 whitespace-nowrap ${
              activeTab === 'company' ? '' : 'border-transparent'
            }`}
            style={
              activeTab === 'company'
                ? {
          ...
          <button
            ...
            className={`px-6 py-4 text-sm font-semibold transition-all border-b-2 whitespace-nowrap ${
              activeTab === 'users' ? '' : 'border-transparent'
            }`}
            style={
              activeTab === 'users'
                ? {
          ...
          <button
            ...
            className={`px-6 py-4 text-sm font-semibold transition-all border-b-2 whitespace-nowrap ${
              activeTab === 'forensics' ? '' : 'border-transparent'
            }`}
            style={
              activeTab === 'forensics'
                ? {
          ...
          <button
            ...
            className={`px-6 py-4 text-sm font-semibold transition-all border-b-2 whitespace-nowrap ${
              activeTab === 'requests' ? '' : 'border-transparent'
            }`}
            style={
              activeTab === 'requests'
                ? {
          ...
          <button
            ...
            className={`px-6 py-4 text-sm font-semibold transition-all border-b-2 whitespace-nowrap ${
              activeTab === 'invites' ? '' : 'border-transparent'
            }`}
            style={
              activeTab === 'invites'
                ? {
                  ...
                  <div className="p-6 sm:p-8 text-center">
                    <div className="max-w-md mx-auto">
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        ...
                        <Button onClick={() => setShowInviteModal(true)} className="min-h-[44px]">
                          Invite Team Member
                        </Button>
                      </div>
                      <p
