      ...
      <div className="flex flex-1 items-center gap-4">
        {onMenuClick && (
          <button
            ...
            className="-ml-2 inline-flex h-10 w-10 items-center justify-center rounded-md text-zinc-600 transition-colors hover:bg-stone-100 hover:text-zinc-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cds-interactive,#D97706)] lg:hidden"
          >
        ...
        {onCommandPalette && (
          <button
            ...
            className="group flex h-10 w-full max-w-xl items-center justify-center gap-3 rounded-lg border border-stone-200 bg-stone-50 px-4 text-left text-sm text-zinc-500 transition-colors hover:border-stone-300 hover:bg-white focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--cds-interactive,#D97706)] sm:justify-start"
          >
            <Search className="h-4 w-4 shrink-0 text-zinc-400" aria-hidden="true" />
            <span className="hidden flex-1 truncate sm:block">
              Search clients, shipments, employees…
            </span>
